...
\begin{table}[H]
    ...
    \caption{Liczba operacji dla algorytmu \texttt{Quick Sort} przy różnych rozmiarach tablicy}
...
\begin{table}[H]
    ...
    \caption{Liczba operacji dla modyfikacji algorytmu \texttt{Quick Sort} przy różnych rozmiarach tablicy}
...
\begin{table}[H]
    ...
    \caption{Liczba operacji dla modyfikacji algorytmu \texttt{Bucket Sort} przy różnych rozmiarach tablicy}
